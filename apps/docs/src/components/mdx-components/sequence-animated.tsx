...
/** biome-ignore-all lint/style/useForOf: safe */
      ...
      {phase === "playing" && (
        ...
        >
          ...
          >
            ...
            <rect height="16" width="3" x="17" y="4" />
          </svg>
        </button>
      )}
      {phase === "done" && (
