...
const withoutNamera = [
  "Hand the agent a private key and hope",
  "Full wallet access with no spending limits",
  "No way to revoke once a key is compromised",
  "Custom permission logic for every integration",
  "No audit trail of what the agent actually did",
];

const withNamera = [
  "Scoped session keys the agent can't exceed",
  "Spend caps, allowlists, rate limits, and expiry",
  "Revoke instantly without touching the main wallet",
  "One policy layer across every wallet and rail",
  "Onchain enforcement with a full audit trail",
];
    ...
    >
      <div className="flex flex-col gap-3">
        ...
        <h2 className="text-3xl max-w-3xl mx-auto text-center heading-gradient pb-2 sm:text-4xl md:text-5xl tracking-tight">
          Give agents financial autonomy.
          <br />
