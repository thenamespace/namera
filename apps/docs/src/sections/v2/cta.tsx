...
const steps = [
  { key: "define", label: "Define policy" },
  { key: "issue", label: "Issue scoped key" },
  { key: "act", label: "Agent acts" },
  { key: "fail", label: "Off-policy fails" },
];
    ...
    >
      ...
      <motion.div className="flex flex-col gap-4" variants={itemVariants}>
        <h2 className="heading-gradient mx-auto max-w-2xl pb-2 text-4xl tracking-tight sm:text-5xl md:text-6xl">
          Ship agents that can spend.
        </h2>
        <p className="mx-auto max-w-md text-sm font-normal leading-relaxed text-muted-foreground md:text-base">
          The permissions layer for agentic money movement. Start with x402
          guardrails in minutes.
        </p>
      </motion.div>
