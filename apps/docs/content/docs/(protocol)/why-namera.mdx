...
title: Why Namera
icon: QuestionIcon
description: "A brief primer on why we built Namera"
---
...
Under the hood, Namera builds on battle-tested smart account infrastructure [ZeroDev](https://zerodev.app/). This means you inherit the reliability, security model, and ecosystem compatibility of existing account abstraction systems. We are not introducing a new wallet standard or asking you to trust experimental primitives. We are using what already works and extending it to support agent-native workflows.
