---
title: ECDSA Smart Account
description: Create a Smart Account with Multichain ECDSA validator
keywords: multichain, smart account, account abstraction, EIP-1193, WalletClient, LocalAccount, ECDSA
---
